  ...
  return (
    <div className="absolute w-full h-full">
      <div className="mt-5 flex justify-center items-center">
        <h1 className="text-2xl md:text-3xl font-semibold uppercase text-grey-500 absolute top-28 mt-1 md:mt-2">
          Finalizar Compra:{" "}
        </h1>
      ...
      {cartProducts.length === 0 ? (
        <div className="text-xl text-center font-bold h-screen flex flex-col items-center justify-center p-7 md:text-2xl">
          ...
          <Link to="/category/remeras">
            <ButtonBack className="mt-5 md:mt-8">¡Prueba agregando uno!</ButtonBack>
          </Link>
        </div>
      ) : (
